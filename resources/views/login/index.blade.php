        ...
        <div class="container-fluid">
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    ...
                    <form action="{{route('verifyLogin.member')}}" method="POST" class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="loginName" class="form-control" id="floatingInput" placeholder="name">
