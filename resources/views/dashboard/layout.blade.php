    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>NTI-Laravel</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    <a href="{{url('/dashboard/banner')}}" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Banner</a>

                    <a href="{{url('/dashboard/projects')}}" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Projects</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row bg-light rounded align-items-center justify-content-center mx-0" style="align-items: flex-start !important; justify-content: flex-start; !important;">
