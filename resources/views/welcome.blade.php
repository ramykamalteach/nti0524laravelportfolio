        ...
        <div class="container">
            ...
            <div class="text-center">
                <ul class="portfolio-filter">
                    ...
                    @foreach ($categories as $oneCategory)
                        <li><a href="#" data-filter=".{{$oneCategory->categoryName}}">
            ...
            <div class="portfolio-items">
                ...
                @foreach ($projects as $oneProject)
                    @php
                        $projectPhoto = asset("site/images/portfolio/" . $oneProject->photo);
                    @endphp
                    <div class="portfolio-item {{ $oneProject->projectCategories }}">
                        <div class="portfolio-item-inner">
                            <img class="img-responsive" src="{{$projectPhoto}}" alt="">
            ...
            <div class="row">
                <div class="col-sm-4 col-xs-6 team-column col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                        <div class="team-img">
                            <img class="img-responsive" src="{{asset('site/images/team/02.jpg')}}" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Jane Man</h3>
                ...
                <div class="col-sm-4 col-xs-6 team-column col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
                        <div class="team-img">
                            <img class="img-responsive" src="{{asset('site/images/team/03.jpg')}}" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Pahlwan</h3>
                            <span>Designer</span>
                ...
                <div class="col-sm-4 col-xs-6 team-column col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
                        <div class="team-img">
                            <img class="img-responsive" src="{{asset('site/images/team/04.jpg')}}" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Nasir uddin</h3>
                            <span>UI/UX</span>
                ...
                <div class="col-sm-4 col-xs-6 team-column col-md-3">
                    <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                        <div class="team-img">
                            <img class="img-responsive" src="{{asset('site/images/team/01.jpg')}}" alt="">
                        </div>
                        <div class="team-info">
                            <h3>Bin Burhan</h3>
